// Generar contraseña en base a dos parametros
//              2 palabras :
// 1 Palabra: vocales en mayuscula
// 2 palabra: todo minuscula
// Alternar las letras de cada palabra (para construir la contraseña)
// Si mas larga anyadimos las letras que sobran
// numero aleatorio entre 100-999

// Paso 1: pal1 vocales  mayuscula
// Paso 2: pal2 todo  minusculas
// Paso 3: mezclamos, lo que sobra lo añadimos
// Paso 4: anyadimos numero aleatorio entre 100 y 999

function vocalesMay(palabra) {
  const vocales = "aeiouaáéíóúàèòüï";
  let resultado = "";
